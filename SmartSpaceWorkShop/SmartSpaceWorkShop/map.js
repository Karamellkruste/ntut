...
function init(centerCoord) {
    ...
    option = {
        mapbox3D: {
            style: 'mapbox://styles/biabobo/cjha51jt70x802rqsorws3xqz', //改地圖到mapbox style裡更換引用的連結
...
function createFlightPointsData(gpsList, height) {
    ...
    for (var k = 0; k < gpsList.length; k++) {
        ...
        coord_data.push({
            ...
            itemStyle: {
                'color': 'white', // white控制路徑線條顏色，可用顏色string yellow or 顏色代碼
                'opacity': 0.8
            }
        });
    }
...
function createSqureCoords(center_coord, radius) { 
    ...
    //建立路徑時註解掉237-251，需要再寫line248，然後
//  var line = [123,123], [], []; 裡面放座標
